...
package.domain = org.maxmessenger
...
source.exclude_dirs = tests, bin, venv, .buildozer, Tools
...
p4a.bootstrap = sdl2
p4a.compile_py = false

p4a.exclude_src = Lib/lib2to3, Lib/test, Lib/idlelib, Lib/bsddb, Lib/distutils, Lib/tkinter, Lib/turtledemo
